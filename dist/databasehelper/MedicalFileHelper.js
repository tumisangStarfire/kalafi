...
class MedicalFileLogic {
}
exports.MedicalFileLogic = MedicalFileLogic;
/**creates and saves a new medicalfile for a patinet */
MedicalFileLogic.create = (medicalFile, callback) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = yield MongoHelper_1.MongoHelper.client.db('Mooki_Development').collection('medicalfile');
...
/**base 64 file */
MedicalFileLogic.uploadMedicalFile = (medicalFile, callback) => __awaiter(void 0, void 0, void 0, function* () {
    try {
            ...
            s3.upload(uploadParams, function (err, data) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (data.Location !== null) { //check if the file has been uploaded to s3,
                        ...
                        yield MedicalFileLogic.create(medicalFile, result => {
                            console.log(result);
...
MedicalFileLogic.removeUploadedFile = (id, callback) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const collection = yield MongoHelper_1.MongoHelper.client.db('Mooki_Development').collection('medicalfile');
        var result = yield collection.findOne({ _id: new ObjectId(id) }, function (err, res) {
            return __awaiter(this, void 0, void 0, function* () {
                console.log(err);
                if (err) {
                    console.log(err);
                ...
                yield collection.deleteOne({ _id: new ObjectId(id) }, function (deleteErr, res) {
                    if (deleteErr) {
...
MedicalFileLogic.getMedicalFilesUsingUserId = (userId, callback) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const collection = MongoHelper_1.MongoHelper.client.db('Mooki_Development').collection('medicalFiles');
...
//# sourceMappingURL=MedicalFileHelper.js.map